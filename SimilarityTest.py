...
class TestSimilarity:
	...
	def test_adjust_value(self):
		...
		assert_equals(adjustedUserDic, {1:[(1,-2),(2,-2),(3,0)],2:[(1,2),(2,2),(4,0)]})

	def test_calculate_similarity(self):

		similarityDict = self.similarity.calculateSimilarity()

		assert_equals(similarityDict[1][2],0)
		assert_equals(similarityDict[2][1],0)
